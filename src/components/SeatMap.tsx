...
export const SeatMap: React.FC<SeatMapProps> = ({
  ...
  return (
    <div id="seat-map-container" className="flex flex-col items-center w-full max-w-4xl mx-auto my-3">
      {/* Curved Cinema Screen with Theatrical Light Glow */}
      <div id="stage-banner" className="w-full max-w-2xl mb-8 flex flex-col items-center relative">
        <div className="w-full h-4 bg-gradient-to-r from-rose-500/20 via-rose-500 to-rose-500/20 rounded-t-full shadow-[0_4px_20px_rgba(244,63,94,0.4)]" />
        <div className="w-3/4 h-8 bg-gradient-to-b from-rose-500/15 to-transparent blur-md -mt-1 pointer-events-none" />
        <div className="flex items-center gap-2 mt-1">
          <Film className="w-3.5 h-3.5 text-rose-500" />
          <span className="text-[11px] uppercase tracking-[0.25em] text-slate-500 font-bold">
      ...
      <div
        id="seat-map-legend"
        className="flex flex-wrap items-center justify-center gap-6 mb-6 px-6 py-3 bg-white border border-slate-200 rounded-xl shadow-xs text-xs text-slate-700"
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-amber-800">Held (5m TTL)</span>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div
        id="seats-grid"
        className="flex flex-col gap-3 p-6 bg-white border border-slate-200/90 rounded-2xl shadow-xs overflow-x-auto w-full max-w-3xl"
      >
